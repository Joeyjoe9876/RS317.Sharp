...
public sealed class Client : RSApplet
{
	...
	public static async Task Main(String[] args)
	{
		try
		{
			...
			localWorldId = int.Parse(args[0]);
			portOffset = int.Parse(args[1]);

			//This client only supports high memory mode.
			setHighMem();
	...
	private void drawLoginScreen(bool originalLoginScreen)
	{
		...
		{
			int _y = y / 2 + 80;
			fontSmall.drawCentredTextWithPotentialShadow("TODO: Remove fletcher text", x / 2, _y, 0x75A9A9, true);
			_y = y / 2 - 20;
