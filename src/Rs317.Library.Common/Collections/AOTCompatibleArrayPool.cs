...
namespace Rs317.Sharp
{
	...
	internal static class ArrayPoolBitOperations
	{
	...
	internal static class ArrayPoolUtilities
	{
		...
		internal static int SelectBucketIndex(int bufferSize)
		{
			...
			int bits = (bufferSize - 1) >> 4;
			return 32 - ArrayPoolBitOperations.LeadingZeroCount(bits);
		}
	...
	/// <summary>
	/// WebGL AOT compatible implementation of <see cref="ArrayPool{T}"/> based on .NET Runtime implementation
	/// found here: https://github.com/dotnet/runtime/blob/4f9ae42d861fcb4be2fcd5d3d55d5f227d30e723/src/libraries/System.Private.CoreLib/src/System/Buffers/ConfigurableArrayPool.cs
	/// </summary>
	/// <typeparam name="T"></typeparam>
	public sealed class AOTCompatibleArrayPool<T> : ArrayPool<T>
	{
		...
		public static ArrayPool<T> SharedSafe { get; } = new AOTCompatibleArrayPool<T>();

		internal AOTCompatibleArrayPool() : this(DefaultMaxArrayLength, DefaultMaxNumberOfArraysPerBucket)
		{
		}
		...
		private sealed class Bucket
		{
			...
			internal void Return(T[] array)
			{
				...
				if(array.Length != _bufferLength)
				{
					...
					throw new ArgumentException($"TODO: Write proper message.");
				}
