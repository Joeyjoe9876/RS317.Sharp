...
{
	//From: https://github.com/clrlslwi/RS-Unity/blob/f4992283f344a3ce7c8e249a5d7e5bcfbd64c853/Assets/RS/util/ColorUtils.cs
	public static class ColorUtils
	{
		...
		public static Color32 RGBToColor(int rgb, int a)
		{
		...
		/// <param name="rgb">The RGB color.</param>
		/// <returns>The created color.</returns>
		public static Color32 RGBToColor(int rgb)
		{
