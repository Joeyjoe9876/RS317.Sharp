...
sealed class TextInput
{
	...
	private static sealed char[] characterList = new char[100];
	private static sealed Buffer stream = new Buffer(new byte[100]);
	private static sealed char[] validChars = { ' ', 'e', 't', 'a', 'o', 'i', 'h', 'n', 's', 'r', 'd', 'l', 'u', 'm',
